...
- 🔭 Currently working on **AI-powered Food Recognition & Recipe Generation**
- 🧠 Exploring **Deep Learning, Transfer Learning & Computer Vision**
- 🛠️ Building real-world apps with **PyTorch + Gradio**
- 🌱 Always learning something new in the AI space
- ⚡ Fun fact: Trained a model to **84.8% accuracy** on 181 food categories!
